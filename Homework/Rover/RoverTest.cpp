...
istream& operator>>(istream& is, MyString& str) {
	...
	while (!is.eof()) {
		...
		MyString newc = MyString(newstr); // MyString: copy constructor //possible error here
		delete[] newstr;
		str += newc; // MyString: operator+=() //possible error here 
	}
	return is;
}
...
int main () {
	...
	cin >> filename; // operator>> is provided above //gets file
