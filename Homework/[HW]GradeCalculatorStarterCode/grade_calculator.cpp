...
int main() {
    ...
    double three = 3;
    double preaverage;
    preaverage = (exam + finalexam) / three;

    if (((exam + finalexam) / 3) > finalexam) {
    ...
    if (hwcount == 0)  {
        hw_average = 0;
            ...
            hw_average = homework / hwcount;}
            if (labcount == 0)  {
                labs = 0;
    }   else {
    lw_average = (labs / labcount) * 100;}
    if (readingcount == 0)  {
        reading = 15;
    }   else {
            reading = (readings / readingcount);
            if (readings <= 85)   {
                reading += 15;}
            else  {
                reading = 100;
    ...
    if (engagementcount == 0)  {
        engagement = 15;
            ...
            engagement = (engagements / engagementcount);
            if (engagement <=85)   {
                engagement += 15;
    }       else{
                engagement = 100;
    ...
    weighted_total = ((exam_average*40) + (hw_average * 40) + (lw_average * 10) + (reading * 5) + (engagement * 5))/100;
